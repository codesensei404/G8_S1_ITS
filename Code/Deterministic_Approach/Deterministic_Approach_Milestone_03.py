...
def route_with_waypoints(graph, route_sequence):
    ...
    for i in range(len(route_sequence) - 1):
        ...
        # Avoid duplicating the overlapping waypoint node in the final list
        if i == 0:
...
if __name__ == "__main__":
    ...
    # Display top probability outcomes from the convolution
